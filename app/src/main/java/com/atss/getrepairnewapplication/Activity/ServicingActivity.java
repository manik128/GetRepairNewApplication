...
public class ServicingActivity extends AppCompatActivity {
    ...
    RadioGroup radiog;
    RadioGroup radiogp;
    String gender, fvalue,time,carts;
...
//        View mActionBarViews = getLayoutInflater().inflate(R.layout.actionbarservicing, null);
//        getSupportActionBar().setCustomView(mActionBarViews);
...
//        getSupportActionBar().setElevation(0);
       ...
       tvselectmakes = (TextView) findViewById(R.id.tvselectmakes);
        ...
        settings = getSharedPreferences(ServicingActivity.this.MyPREFERENCES, 0);// 0 - for private mode
       ...
       cp = new Cartpage(cart,ServicingActivity.this);
...
//           ;
         ArrayAdapter<String> adapter1 =
                  ...
                  spinnerfloors.setOnItemSelectedListener(onItemSelectedListener0);
                    ...
                    final View mActionBarView = getLayoutInflater().inflate(R.layout.actionbarservicing, null);
...
//                    tvcommercial = (TextView)ivactionmenu.findViewById(R.id.tvcommercial);
//                    tvcommercial.setText("New Construction");
                        ...
                        tvfour.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if(timeslot!=null) {
                                    ...
                                    tvcount2.setText("00");
                                    tvcount3.setText("00");
                                    if(tvintime.getText().toString().equalsIgnoreCase("Intime")){
                            ...
                            public void onClick(View v) {
                                ...
                                if(timeslot!=null) {
                                    ...
                                    if(tvintime.getText().toString().equalsIgnoreCase("Intime")){
                                        ...
                                        tvouttime.setText(fvalue);}
                                }else if(tvintime.getText().toString().equalsIgnoreCase("Intime")){
                                    tvouttime.setText("Outtime");
...
//                tvselectmake.setText("Add to service");
                    ...
                    sprs1.setOnItemSelectedListener(onItemSelectedListener0);
//
                    View mActionBarView1 = getLayoutInflater().inflate(R.layout.actionbarservicing, null);
                    getSupportActionBar().setCustomView(mActionBarView1);
                    getSupportActionBar().setDisplayOptions(getSupportActionBar().DISPLAY_SHOW_CUSTOM);
                    getSupportActionBar().setElevation(0);
                    tvcommercial=(TextView)mActionBarView1.findViewById(R.id.tvcommercial);
                    ...
                    ivactionmenu = (ImageView) mActionBarView1.findViewById(R.id.ivactionmenu);
                    ivactionmenu.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(ServicingActivity.this,MainActivity12.class);
...
//        if(finalHour == 12 && format.equalsIgnoreCase("AM") ){
//            selhrs=0;
//        }
//        else{
            //selhrs=finalHour;
...
//        }
        ...
        // tvouttime.setText(new StringBuilder().append(time).append(" : ").append(min)
            //    .append(" ").append(format));
...
//    }
    ...
    public void onBackPressed() {
            ...
            Intent loginIntent = new Intent(ServicingActivity.this,HomePage.class);
    ...
    public void cartprocess(View view1){
        //                 else {
        ...
        if (pos == 0) {
            ...
            if (etselectmakes.getText().toString().equals("")) {
                Snackbar.make(view1,"Please Enter issue", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                etselectmakes.setError(null);
...
//                            anim.start();
                ...
                badgenotification1 = (TextView) mActionBarView.findViewById(R.id.badgent);
                tvcommercial = (TextView)mActionBarView.findViewById(R.id.tvcommercial);
                tvcommercial.setText(catvalue);
                gr.grfonttxt(tvcommercial);

                res=cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),etselectmakes.getText().toString(),"AutoMobiles");
                if(res.equalsIgnoreCase("success")){
                    badgenotification1.setVisibility(View.VISIBLE);
                    //badgenotification.setVisibility(View.VISIBLE);
                    int badgecnt=  Integer.parseInt(badgenotification1.getText().toString());
                    int s=badgecnt+1;
                    Toast.makeText(ServicingActivity.this,"automobiles"+ result,Toast.LENGTH_LONG).show();
                    badgenotification1.setText(Integer.toString(s));
                    getSupportActionBar().setCustomView(mActionBarView);

                }
                else if(res.equalsIgnoreCase("exist")){
                    Snackbar.make(view1, "This service is already in your cart", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                }
...
//                        }
            ...
            if (sertyp == 0) {
                ...
                else if(Budget.equals("Select Budget"))
                {
                    ...
                    tvcommercial = (TextView)mActionBarView.findViewById(R.id.tvcommercial);
                    tvcommercial.setText(catvalue);
                    // String  asize=etminimum.getText().toString()+spinnersqft.getSelectedItem().toString();
                  res= cp.buliding(mclass.getType(),mclass.getModel(),mclass.getService(),size+areas,floorses,Budget,"Building/Construction");
                    if(res.equalsIgnoreCase("success")){
                        badgenotification1.setVisibility(View.VISIBLE);
                        ...
                        int badgecnt=  Integer.parseInt(badgenotification1.getText().toString());
                        int s=badgecnt+1;
                        Toast.makeText(ServicingActivity.this," building"+ badgecnt+s,Toast.LENGTH_LONG).show();
                        badgenotification1.setText(Integer.toString(s));
                        getSupportActionBar().setCustomView(mActionBarView);
                        Snackbar.make(view, "This service is already in your cart", Snackbar.LENGTH_LONG)
                                .setAction("Action", null).show();
                    }
                    else if(res.equalsIgnoreCase("exist")){
                        Snackbar.make(view, "This service is already in your cart", Snackbar.LENGTH_LONG)
            ...
            if (sertyp == 1) {
                ...
                else if(Budget.equals("Select Budget"))
                {
                    ...
                    tvcommercial.setText(catvalue);
                    // String  asize=etminimum.getText().toString()+spinnersqft.getSelectedItem().toString();
                    res= cp.buliding(mclass.getType(),mclass.getModel(),mclass.getService(),size+areas,"",Budget,"Building/Construction");
                    ...
                    if(res.equalsIgnoreCase("success")){
                        ...
                        int badgecnt=  Integer.parseInt(badgenotification1.getText().toString());
                        int s=badgecnt+1;
                        Toast.makeText(ServicingActivity.this,"building2"+ badgecnt+s,Toast.LENGTH_LONG).show();
                        badgenotification1.setText(Integer.toString(s));
                        getSupportActionBar().setCustomView(mActionBarView);
            ...
            if (sertyp == 2) {
                ...
                else if(Budget.equals("Select Budget"))
                {
                    ...
                    if(res.equalsIgnoreCase("success")){
                        ...
                        int badgecnt=  Integer.parseInt(badgenotification1.getText().toString());
                        int s=badgecnt+1;
                        Toast.makeText(ServicingActivity.this," building3"+ badgecnt+s,Toast.LENGTH_LONG).show();
                        badgenotification1.setText(Integer.toString(s));
                        getSupportActionBar().setCustomView(mActionBarView);
...
//                            anim.start();
                ...
                res=cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),etselectmakes.getText().toString(),"Home Appliances");
                if(res.equalsIgnoreCase("success")) {
                    badgenotification1.setVisibility(View.VISIBLE);
                    //badgenotification.setVisibility(View.VISIBLE);
                    int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
                    int s = badgecnt + 1;
                    Toast.makeText(ServicingActivity.this, " home" + badgecnt + s, Toast.LENGTH_LONG).show();
                    badgenotification1.setText(Integer.toString(s));
                    getSupportActionBar().setCustomView(mActionBarView);
...
// } }
                 ...
                 res= cp.Manpowerservice (mclass.getType(),mclass.getModel(),mclass.getService(),timeslot,mclass.getQty(),mclass.getIntime(),mclass.getOuttime(),mclass.getChoose(),mclass.getWeekoff(),mclass.getGender(),"Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
                 ...
                 res= cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getissue(),"Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
                        int s = badgecnt + 1;
                        Toast.makeText(ServicingActivity.this, " badgecnt" + badgecnt + s, Toast.LENGTH_LONG).show();
                        badgenotification1.setText(Integer.toString(s));
                        getSupportActionBar().setCustomView(mActionBarView);
                    }
                        else if(res.equalsIgnoreCase("exist")){
...
//                            anim.start();
                 ...
                 res= cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getissue(),"Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        ...
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
                        int s = badgecnt + 1;
                        Toast.makeText(ServicingActivity.this, " facility" + badgecnt + s, Toast.LENGTH_LONG).show();
                        badgenotification1.setText(Integer.toString(s));
                        getSupportActionBar().setCustomView(mActionBarView);
                    }
                        else if(res.equalsIgnoreCase("exist")){
...
//                            anim.start();
                  ...
                  res= cp.Moverpackers(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getCompany(),mclass.getVehicleqty(),mclass.getElectricalqty(),mclass.getFurnitureqty(),mclass.getCurrently(),mclass.getServicelift(),mclass.getmove(),mclass.getYes(),mclass.getFrom(),mclass.getTo(),"Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
                 ...
                 res=cp.ToursandTravelers(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getCompany(),mclass.getFrom(),mclass.getTo(),mclass.getAdult(),mclass.getchild(),mclass.getVechicle(),mclass.getTripfrom(),mclass.getTripto(),"Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
                ...
                res= cp.RealEstate(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getCompany(),mclass.getBuliding(),mclass.getAddress(),mclass.getQuotation(),mclass.getNegotiation(),mclass.getFloor(),"","Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
                   ...
                   res= cp.RealEstate(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getCompany(),mclass.getBuliding(),mclass.getAddress(),mclass.getBudget(),"",mclass.getFloor(),"","Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
                  ...
                  res=  cp.RealEstate(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getCompany(),mclass.getBuliding(),mclass.getAddress(),mclass.getQuotation(),mclass.getNegotiation(),"",mclass.getYear(),"Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
// } }
                ...
                res= cp.Manpowerservice(mclass.getType(),mclass.getModel(),mclass.getService(),timeslot,mclass.getQty(),mclass.getIntime(),mclass.getOuttime(),mclass.getChoose(),mclass.getWeekoff(),mclass.getService(),"Facility Management");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
               ...
               res= cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),etselectmakes.getText().toString(),"Repair Maintaince");
                if(res.equalsIgnoreCase("success")) {
                    badgenotification1.setVisibility(View.VISIBLE);
                    //badgenotification.setVisibility(View.VISIBLE);
                    int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
              ...
              res=  cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getissue(),"Interiorwork/Suppliers");
                if(res.equalsIgnoreCase("success")) {
                    badgenotification1.setVisibility(View.VISIBLE);
                    //badgenotification.setVisibility(View.VISIBLE);
                    int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
               ...
               res= cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getissue(),"Beauty Salon/Parlour");
                if(res.equalsIgnoreCase("success")) {
                    badgenotification1.setVisibility(View.VISIBLE);
                    //badgenotification.setVisibility(View.VISIBLE);
                    int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
                    ...
                    badgenotification1 = (TextView) mActionBarView.findViewById(R.id.badgent);
                    tvcommercial = (TextView)mActionBarView.findViewById(R.id.tvcommercial);
                    tvcommercial.setText("Function");
                    gr.grfonttxt(tvcommercial);

                   res= cp.Events(mclass.getType(),mclass.getModel(),mclass.getService()," ",size,multiAutoCompleteTextView1.getText().toString(),"Events");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
             ...
             res= cp.specialins(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getModel(),"Events");
                if(res.equalsIgnoreCase("success")) {
                    badgenotification1.setVisibility(View.VISIBLE);
                    //badgenotification.setVisibility(View.VISIBLE);
                    int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
...
//                            anim.start();
                  ...
                  res=  cp.Events(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getVeg(),size,multiAutoCompleteTextView1.getText().toString(),"Events");
                    if(res.equalsIgnoreCase("success")) {
                        badgenotification1.setVisibility(View.VISIBLE);
                        //badgenotification.setVisibility(View.VISIBLE);
                        int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
            ...
            size = sprs1.getSelectedItem().toString();
            if (size.equals("Select Budget")) {
                Snackbar.make(view1, "Choose Budget Field", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                rlrs1.setBackgroundResource(R.drawable.myborderbuildingerror);
                Animation startAnimation = AnimationUtils.loadAnimation(getApplicationContext(), R.animator.blinking_animation);
                rlrs1.startAnimation(startAnimation);
                ...
                badgenotification1 = (TextView) mActionBarView.findViewById(R.id.badgent);
                tvcommercial = (TextView)mActionBarView.findViewById(R.id.tvcommercial);
                tvcommercial.setText("Financial loans");
                gr.grfonttxt(tvcommercial);

              res=  cp.budgets(mclass.getType(),mclass.getModel(),mclass.getService(),mclass.getBudget(),"Financial loans");
                if(res.equalsIgnoreCase("success")) {
                    badgenotification1.setVisibility(View.VISIBLE);
                    //badgenotification.setVisibility(View.VISIBLE);
                    int badgecnt = Integer.parseInt(badgenotification1.getText().toString());
