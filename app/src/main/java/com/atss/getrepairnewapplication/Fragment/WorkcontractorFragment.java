...
public  class WorkcontractorFragment extends Fragment {
    LinearLayout linearbike;
    int j;
    String[] models={"Electrical contractor","POP contractor","Plumbing contractor","Flooring contractor","Civil contractor","Window blinds/curtains contractor","Aluminum fabrication Workcontractor","Others"};
    ...
    View view1, view2;
    @SuppressLint("ValidFragment")
    public WorkcontractorFragment(Context cont){
     con=cont;
    }
    @Nullable
    @Override
...
//
                        ...
                        txtlay.setHint("Enter WorkContractor Type Here");
                        ...
                        btnno.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (etemail.getText().toString().equals("")) {
                                    Toast.makeText(getActivity(), "Work Contractor type Should not be blank", Toast.LENGTH_LONG).show();
//
                                } else {
                                    builder = new AlertDialog.Builder(getContext());
