...
public class FemaleFragment extends Fragment {
    ...
    int j;
    String[] models={"Hair Cut & Styles","Clean up","Manicure","Pedicure","Bridal Makeup","Laser Hair Removal","Mehandi","Others"};
    AlertDialog.Builder builder;
    AlertDialog alertDialog;
    int count=1,count1=1;
    View v2;
    Mainclass mclass;
    String[]cons={"schedule  appointment  in parlour","Book  appointment in home"};
    @Nullable
    @Override
