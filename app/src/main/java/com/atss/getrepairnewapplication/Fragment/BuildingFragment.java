...
public class BuildingFragment extends Fragment {
    ...
    String[] models = {"Appartment","Commerical OfficeSpace", "IndividualHouse", "Villa", "Shoppingmall", "PentHouse", "GuestHouse", "Others"};
String[]cons={"New Construction","Renovation"};
    ...
    View v2=null;
    Mainclass mclass;
    public BuildingFragment(Context cont){
        con=cont;
    }
    @Nullable
    @Override
                            ...
                            finalVw.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (v2 != null) {
                                        ...
                                        iv2 = (ImageView) v2.findViewById(R.id.ivlist);
                                        iv2.setImageResource(R.drawable.checkbox);
                                    ...
                                    iv3 = (ImageView) v.findViewById(R.id.ivlist);
                            ...
                            btnsubmit.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    intent.putExtra("sertyp", 0);
                                                ...
                                                intent.putExtra("message", cons[finalI]);

                                    mclass.setType("Building");
...
//
                        ...
                        grfont gr = new grfont(getContext());
                    txtlay.setHint("Enter Building Type Here");
                        ...
                        btnno.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (etemail.getText().toString().equals("")) {
                                    Toast.makeText(getActivity(), "Building type field Should not be blank", Toast.LENGTH_LONG).show();
//
                                } else {
