...
public class ArchFragment extends Fragment {
    ...
    int j;
    String[] models = {"Appartment", "IndividualHouse", "Villa", "Shoppingmall", "PentHouse", "GuestHouse", "Others"};
...
//
                        ...
                        grfont gr = new grfont(getContext());
                        txtlay.setHint("Enter Architecture Type Here");
                        ...
                        btnno.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (etemail.getText().toString().equals("")) {
                                    Toast.makeText(getActivity(), "Architecture type field Should not be blank", Toast.LENGTH_LONG).show();
//
                                } else {
